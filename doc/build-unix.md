UNIX BUILD NOTES
====================
Some notes on how to build greenrenovatedbonds Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Base build dependencies
-----------------------
Building the dependencies and greenrenovatedbonds Core requires some essential build tools and libraries to be installed before.
...
Security
--------
To help make your greenrenovatedbonds installation more secure by making certain attacks impossible to
...
* Position Independent Executable
    ...
    To test that you have built PIE executable, install scanelf, part of paxutils, and use:
    	...
    	scanelf -e ./greenrenovatedbondsd
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, greenrenovatedbonds Core should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, greenrenovatedbonds Core may be compiled in
...
Add `CC=egcc CXX=eg++ CPP=ecpp` to the dependencies build and the greenrenovatedbonds Core build:
```bash
$ cd depends
