...
This mechanism has been integrated into Bitcore-Node-greenrenovatedbonds which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/greenrenovatedbondspay/insight-api-greenrenovatedbonds#web-socket-api](https://github.com/greenrenovatedbondspay/insight-api-greenrenovatedbonds#web-socket-api)
* API: [https://github.com/greenrenovatedbondspay/insight-api-greenrenovatedbonds#instantsend-transactions](https://github.com/greenrenovatedbondspay/insight-api-greenrenovatedbonds#instantsend-transactions)
