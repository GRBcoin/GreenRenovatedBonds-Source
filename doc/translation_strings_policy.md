...
This document provides guidelines for internationalization of the greenrenovatedbonds Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `greenrenovatedbonds_en.ts` remains unchanged.
