...
EXPECTED_HOLDER_NAMES = [
    ...
    "The greenrenovatedbonds Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a greenrenovatedbonds Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The greenrenovatedbonds Core developers'
...
Arguments:
    <base_directory> - The base directory of greenrenovatedbonds Core source code repository.
"""
...
Arguments:
    <file> - A source file in the greenrenovatedbonds Core repository.
"""
