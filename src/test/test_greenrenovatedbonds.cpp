...
#define BOOST_TEST_MODULE greenrenovatedbonds Test Suite

#include "test_greenrenovatedbonds.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_greenrenovatedbonds_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
