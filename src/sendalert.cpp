...
2. run greenrenovatedbondsd with -printalert or -sendalert like this:
   /path/to/greenrenovatedbondsd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.greenrenovatedbonds.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/greenrenovatedbonds Core:0.12.0.58/"));
