...
// Copyright (c) 2021 The greenrenovatedbonds Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1621188911, nBits=1e0ffff0, nNonce=1165224, vtx=1)
...
{
    const char* pszTimestamp = "A New Green Concept 02 february 2021";
    const CScript genesisOutputScript = CScript() << ParseHex("049f13847e50c19b7c27460e8f6f80786a1279301a046a83c0c5a1b0cc29707eb30d64827f5963f805401a753f75a59d213a02908689c8952ac073c7bfba23099d") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nMasternodeMinimumConfirmations = 18;
        ...
        consensus.defaultAssumeValid = uint256S("0x00000c83e078e24f6a75527d9e2f1c7e7ffd3b10573b5428fcf2312bf03ec944"); 
        ...
        vAlertPubKey = ParseHex("04e1b71f0937ea935a52a4bffc0c3790d32e919ec04fc37967d74cad148bb0c4c0f61e42d7a7685b2f66178c686869e0e930e14906f1b1219b879ab8934539bf7c");
        nDefaultPort = 35514;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1621188911, 1165224, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000c83e078e24f6a75527d9e2f1c7e7ffd3b10573b5428fcf2312bf03ec944"));
        assert(genesis.hashMerkleRoot == uint256S("0x9cf4796255f6d573e653e44305e78d7cf68bf2b3d0f20537ce8415adfa568055"));
        ...
        // greenrenovatedbonds BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // greenrenovatedbonds BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // greenrenovatedbonds BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"GU9GDwJCP4d43odyA3zTYSbGvqfKdonJJH"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000c83e078e24f6a75527d9e2f1c7e7ffd3b10573b5428fcf2312bf03ec944"))
        };

        chainTxData = ChainTxData{
            1621188911, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000726f8123408b915f2385db7007f06980eeac6d9603908c2ee98f643fc38"); 

        pchMessageStart[0] = 0xb4;
        pchMessageStart[1] = 0xce;
        pchMessageStart[2] = 0xe6;
        pchMessageStart[3] = 0x0b;
        vAlertPubKey = ParseHex("04f012815eb13da4d2f47e08afd74948cfc5fb3f2ff59ee99dc510be81ca45c229d98f03bde103503d45099d514c5112af6630327bde43b4279e24756f383ba625");
        nDefaultPort = 45514;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1621188916UL, 1136090UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000726f8123408b915f2385db7007f06980eeac6d9603908c2ee98f643fc38"));
        assert(genesis.hashMerkleRoot == uint256S("0x9cf4796255f6d573e653e44305e78d7cf68bf2b3d0f20537ce8415adfa568055"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,166);
        // Testnet greenrenovatedbonds BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet greenrenovatedbonds BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet greenrenovatedbonds BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"GTgh9acLx5mRZPamg7akWFJxLWfmAcMoRw"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000726f8123408b915f2385db7007f06980eeac6d9603908c2ee98f643fc38"))
        };

        chainTxData = ChainTxData{
            1621188916, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1621188921, 1, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0530efde906a2fcfea737f1fbefe3a011819b88cade84c98fab226b4f765cc3b"));
        assert(genesis.hashMerkleRoot == uint256S("0x9cf4796255f6d573e653e44305e78d7cf68bf2b3d0f20537ce8415adfa568055"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x0530efde906a2fcfea737f1fbefe3a011819b88cade84c98fab226b4f765cc3b"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6ZuvXvf5uanK13R3afCpVQTSFRvTCVjtvdZFcQHwZkwdnPMEN8x
        vSporkAddresses = {"GSgjrqX7EWLotTGCmeQUrjUxtLzAiaeRXN"};
        nMinSporkKeys = 1;
        ...
        // Regtest greenrenovatedbonds addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,38);
        // Regtest greenrenovatedbonds script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,39);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,166);
        // Regtest greenrenovatedbonds BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest greenrenovatedbonds BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest greenrenovatedbonds BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
