...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all greenrenovatedbonds related functionality
...
/*
    ...
    allow endless transaction that would bloat greenrenovatedbonds and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all greenrenovatedbonds specific functionality
