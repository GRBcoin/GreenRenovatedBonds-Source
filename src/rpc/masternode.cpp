...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner greenrenovatedbonds address\n"
            "  payee          - Print the masternode payout greenrenovatedbonds address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting greenrenovatedbonds address\n"
        );
}
...
UniValue masternode_outputs(const JSONRPCRequest& request)
{
    ...
    pwallet->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_40000);
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "greenrenovatedbonds",               "masternode",             &masternode,             true,  {} },
    { "greenrenovatedbonds",               "masternodelist",         &masternodelist,         true,  {} },
    { "greenrenovatedbonds",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "greenrenovatedbonds",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
