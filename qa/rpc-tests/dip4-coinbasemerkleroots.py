...
from test_framework.test_framework import greenrenovatedbondsTestFramework
...
class LLMQCoinbaseCommitmentsTest(greenrenovatedbondsTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as greenrenovatedbondsTestFramework doesn't support this atm)
